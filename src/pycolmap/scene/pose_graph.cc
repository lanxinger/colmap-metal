...
void BindPoseGraph(py::module& m) {
  ...
  py::classh<PoseGraph>(m, "PoseGraph")
      ...
      .def("compute_largest_connected_frame_component",
           ...
           "reconstruction"_a,
           "filter_unregistered"_a = true,
           "Compatibility alias for largest_connected_frame_component.")
      ...
      .def(
          ...
          [](const PoseGraph& self,
            ...
            const int num_components = self.MarkConnectedComponents(
          ...
          "reconstruction"_a,
          "min_num_images"_a = -1,
          "Compatibility wrapper for marking connected frame components.");
}
